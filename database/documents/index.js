module.exports =({address,city,phoneNo,postalCode,country}) => {
                        ...
                        <div class="widget-box">
                            <div class="widget-header widget-header-large">
                                ...
                                <div class="widget-toolbar no-border invoice-info">
                                    ...
                                    <span class="blue">${`${today.getDate()}.${today.getMonth() + 1}.${today.getFullYear()}.`}</span>
                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div>
                                                <ul class="list-unstyled spaced">
                                                    ...
                                                    <li>
                                                        <i class="ace-icon fa fa-caret-right blue"></i>${postalCode}
                                                    </li>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div>
                                                <ul class="list-unstyled  spaced">
                                                    ...
                                                    <li>
                                                        <i class="ace-icon fa fa-caret-right green"></i>${postalCode}
                                                    </li>
